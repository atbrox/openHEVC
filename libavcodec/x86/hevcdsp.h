...
void ff_hevc_put_hevc_epel_hv_8_sse(int16_t *dst, ptrdiff_t dststride,uint8_t *_src, ptrdiff_t _srcstride,ptrdiff_t width, ptrdiff_t height, ptrdiff_t mx, ptrdiff_t my);
