...
/***********************************/
/* MC */
void ff_put_hevc_epel_v_master_8_sse4(int16_t *dst, ptrdiff_t dststride, uint8_t *_src, ptrdiff_t _srcstride, ptrdiff_t width, ptrdiff_t height, ptrdiff_t mx, ptrdiff_t my, int16_t* mcbuffer);
void ff_put_hevc_epel_h_master_8_sse4(int16_t *dst, ptrdiff_t dststride, uint8_t *_src, ptrdiff_t _srcstride, ptrdiff_t width, ptrdiff_t height, ptrdiff_t mx, ptrdiff_t my, int16_t* mcbuffer);
void ff_put_hevc_epel_hv_4_8_sse4(int16_t *dst, ptrdiff_t dststride, uint8_t *_src, ptrdiff_t _srcstride, ptrdiff_t width, ptrdiff_t height, ptrdiff_t mx, ptrdiff_t my, int16_t* mcbuffer);


#define MCQ_FUNC(DIR, DEPTH, OPT)                                        \
    void ff_put_hevc_mc_pixels_ ## DIR ## _ ## DEPTH ## _ ## OPT(int16_t *dst, ptrdiff_t dststride, uint8_t *_src, ptrdiff_t _srcstride, ptrdiff_t width, ptrdiff_t height, ptrdiff_t mx, ptrdiff_t my, int16_t* mcbuffer);
        ...
        if (EXTERNAL_MMX(mm_flags)) {
            ...
            if (EXTERNAL_MMXEXT(mm_flags)) {
                ...
                if (EXTERNAL_SSSE3(mm_flags)) {
...
#if 0//ARCH_X86_64
                    c->put_hevc_qpel[0][0][0] = ff_put_hevc_mc_pixels_2_8_sse4;
                    c->put_hevc_qpel[1][0][0] = ff_put_hevc_mc_pixels_4_8_sse4;
                    c->put_hevc_qpel[2][0][0] = ff_put_hevc_mc_pixels_8_8_sse4;
                    c->put_hevc_qpel[3][0][0] = ff_put_hevc_mc_pixels_16_8_sse4;
                    c->put_hevc_qpel[4][0][0] = ff_put_hevc_mc_pixels_16_8_sse4;
#else
                    c->put_hevc_qpel[0][0][0] = ff_hevc_put_hevc_qpel_pixels4_8_sse;
                    c->put_hevc_qpel[1][0][0] = ff_hevc_put_hevc_qpel_pixels8_8_sse;
                    c->put_hevc_qpel[2][0][0] = ff_hevc_put_hevc_qpel_pixels16_8_sse;
                    c->put_hevc_qpel[3][0][0] = ff_hevc_put_hevc_qpel_pixels16_8_sse;
                    c->put_hevc_qpel[4][0][0] = ff_hevc_put_hevc_qpel_pixels16_8_sse;
#endif
                    ...
                    c->put_hevc_qpel[0][1][0] = c->put_hevc_qpel[1][1][0] = ff_hevc_put_hevc_qpel_v4_1_8_sse;
                    c->put_hevc_qpel[2][1][0] = c->put_hevc_qpel[3][1][0] = c->put_hevc_qpel[4][1][0] = ff_hevc_put_hevc_qpel_v16_1_8_sse;

                    c->put_hevc_qpel[0][2][0] = c->put_hevc_qpel[1][2][0] = ff_hevc_put_hevc_qpel_v4_2_8_sse;
                    c->put_hevc_qpel[2][2][0] = c->put_hevc_qpel[3][2][0] = c->put_hevc_qpel[4][2][0] = ff_hevc_put_hevc_qpel_v16_2_8_sse;

                    c->put_hevc_qpel[0][3][0] = c->put_hevc_qpel[1][3][0] = ff_hevc_put_hevc_qpel_v4_3_8_sse;
                ...
                if (EXTERNAL_SSE4(mm_flags)) {
...
#if 0//ARCH_X86_64
                    c->put_hevc_epel[0][0] = ff_put_hevc_mc_pixels_master_8_sse4;
                    c->put_hevc_epel[0][1] = ff_put_hevc_epel_h_master_8_sse4;
                    c->put_hevc_epel[1][0] = ff_put_hevc_epel_v_master_8_sse4;
                    c->put_hevc_epel[1][1] = ff_put_hevc_epel_hv_4_8_sse4;

#else
                    c->put_hevc_epel[0][0][0] = c->put_hevc_epel[1][0][0] = c->put_hevc_epel[2][0][0] = c->put_hevc_epel[3][0][0] = c->put_hevc_epel[4][0][0] = ff_hevc_put_hevc_epel_pixels_8_sse;
                    c->put_hevc_epel[0][0][1] = c->put_hevc_epel[1][0][1] = c->put_hevc_epel[2][0][1] = c->put_hevc_epel[3][0][1] = c->put_hevc_epel[4][0][1] = ff_hevc_put_hevc_epel_h_8_sse;
                    ...
                    c->put_hevc_epel[0][1][1] = ff_hevc_put_hevc_epel_hv_8_2_sse;
                    c->put_hevc_epel[1][1][1] = ff_hevc_put_hevc_epel_hv_8_4_sse;
                    c->put_hevc_epel[2][1][1] = c->put_hevc_epel[3][1][1] = c->put_hevc_epel[4][1][1] = ff_hevc_put_hevc_epel_hv_8_8_sse;
                    ...
                    c->put_hevc_qpel[0][1][1] = ff_hevc_put_hevc_qpel_h4_1_v_1_sse;
                    c->put_hevc_qpel[1][1][1] = c->put_hevc_qpel[2][1][1] = c->put_hevc_qpel[3][1][1] = c->put_hevc_qpel[4][1][1] = ff_hevc_put_hevc_qpel_h8_1_v_1_sse;
                    c->put_hevc_qpel[0][2][2] = ff_hevc_put_hevc_qpel_h4_2_v_2_sse;
                    c->put_hevc_qpel[1][2][2] = c->put_hevc_qpel[2][2][2] = c->put_hevc_qpel[3][2][2] = c->put_hevc_qpel[4][2][2] = ff_hevc_put_hevc_qpel_h8_2_v_2_sse;
                    c->put_hevc_qpel[0][3][2] = ff_hevc_put_hevc_qpel_h4_2_v_3_sse;
                    c->put_hevc_qpel[1][3][2] = c->put_hevc_qpel[2][3][2] = c->put_hevc_qpel[3][3][2] = c->put_hevc_qpel[4][3][2] = ff_hevc_put_hevc_qpel_h8_2_v_3_sse;
                    c->put_hevc_qpel[0][2][1] = ff_hevc_put_hevc_qpel_h4_1_v_2_sse;
                    ...
                    c->put_hevc_qpel[0][2][3] = ff_hevc_put_hevc_qpel_h4_3_v_2_sse;
                    c->put_hevc_qpel[1][2][3] = c->put_hevc_qpel[2][2][3] = c->put_hevc_qpel[3][2][3] = c->put_hevc_qpel[4][2][3] = ff_hevc_put_hevc_qpel_h8_3_v_2_sse;
