...
#define TRANSQUANT_BYPASS(SZ)                                                           \
        static void FUNC(transquant_bypass ## SZ ## x ## SZ)(uint8_t *_dst, int16_t *coeffs,   \
                                               ptrdiff_t stride)                        \
        {                                                                               \
            int x, y;                                                                   \
            pixel *dst = (pixel *)_dst;                                                 \
...
TRANSQUANT_BYPASS(4)
TRANSQUANT_BYPASS(8)
TRANSQUANT_BYPASS(16)
TRANSQUANT_BYPASS(32)

#undef TRANSQUANT_BYPASS
...
static void FUNC(put_hevc_epel_pixels)(int16_t *dst, ptrdiff_t dststride,
                                       uint8_t *_src, ptrdiff_t _srcstride,
                                       ptrdiff_t width, ptrdiff_t height, ptrdiff_t mx, ptrdiff_t my)
{
    int x, y;
    pixel *src          = (pixel *)_src;
    ptrdiff_t srcstride = _srcstride / sizeof(pixel);
